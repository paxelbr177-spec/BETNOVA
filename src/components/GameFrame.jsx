...
export default function GameFrame({ game }) {
  ...
  return (
    <div
      ref={wrapRef}
      className="relative h-[88vh] min-h-[700px] w-full overflow-hidden rounded-2xl border border-white/10 bg-ink shadow-card sm:h-auto sm:min-h-0 sm:aspect-video"
